...
public final class FlywayFactory {
    ...
    @Getter
    @Setter
    private boolean baselineOnMigrate = DEFAULT_BASELINE_ON_MIGRATE;

    @Getter
    @Setter
    private boolean group = DEFAULT_GROUP;
    ...
    @Getter
    @Setter
    private boolean ignoreMissingMigrations = DEFAULT_IGNORE_MISSING_MIGRATIONS;

    @Getter
    @Setter
    private boolean ignoreIgnoredMigrations = DEFAULT_IGNORE_IGNORED_MIGRATIONS;

    @Getter
    @Setter
    private boolean ignorePendingMigrations = DEFAULT_IGNORE_PENDING_MIGRATIONS;

    @Getter
    @Setter
    private boolean ignoreFutureMigrations = DEFAULT_IGNORE_FUTURE_MIGRATIONS;

    @Getter
    @Setter
    private boolean validateOnMigrate = DEFAULT_VALIDATE_ON_MIGRATE;

    @Getter
    @Setter
    private boolean cleanOnValidationError = DEFAULT_CLEAN_ON_VALIDATION_ERROR;

    @Getter
    @Setter
    private boolean cleanDisabled = DEFAULT_CLEAN_DISABLED;

    @Getter
    @Setter
    private List<String> locations = DEFAULT_LOCATIONS;
    ...
    @Getter
    @Setter
    private boolean placeholderReplacement = DEFAULT_PLACEHOLDER_REPLACEMENT;

    @Getter
    @Setter
    private Map<String, String> placeholders = DEFAULT_PLACEHOLDERS;
    ...
    @Getter
    @Setter
    private String sqlMigrationPrefix = DEFAULT_SQL_MIGRATION_PREFIX;
    ...
    public Flyway build(@NonNull DataSourceFactory factory) {
        return Flyway.configure()
                .dataSource(factory.getUrl(), factory.getUser(), factory.getPassword())
